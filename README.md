...
## 🌟 О проекте
Данный проект предстаеляет собой Java бэкенд-часть веб-приложения для мониторинга психофизиологического состояния участников арктических экспедиций. 
...
- REST API Python-микросервис (используется для генерации графиков и аналитики, для аналитики использутеся GigaChat API);
